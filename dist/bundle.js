...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"FileSystem\": () => (/* binding */ FileSystem)\n/* harmony export */ });\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\nvar FileSystem = /*#__PURE__*/function () {\n  function FileSystem() {\n    _classCallCheck(this, FileSystem);\n\n    this.content = [];\n    this.name = '~';\n    this.currentPath = \"~\";\n    this.absolutePath = \"~\";\n    this.currentDir = this;\n  }\n\n  _createClass(FileSystem, [{\n    key: \"handleError\",\n    value: function handleError(message) {\n      throw new Error(message);\n    }\n  }, {\n    key: \"add\",\n    value: function add(file) {\n      if (this.currentPath === \"~\") {\n        this.content.push(file);\n      } else {\n        this.currentDir.addDir(file);\n      }\n    }\n  }, {\n    key: \"updatePathAndDir\",\n    value: function updatePathAndDir(dir) {\n      var path = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;\n      this.currentDir = dir;\n      debugger;\n      this.currentPath = path ? path : \"\".concat(dir.absolutePath, \"/\").concat(dir.name);\n    }\n  }, {\n    key: \"changeDir\",\n    value: function changeDir(dir) {\n      var path = dir.split('/').filter(function (e) {\n        return e !== '';\n      });\n\n      if (path.length === 1) {\n        if (path[0] === \"~\") {\n          this.updatePathAndDir(this, \"~\");\n        } else if (path[0] === \"..\") {\n          this.currentDir.parentDirectory ? this.updatePathAndDir(this.currentDir.parentDirectory) : this.handleError(\"cd \".concat(dir, \": End of file system\"));\n        } else {\n          var file = this.currentDir.content.find(function (d) {\n            return d.name === path[0];\n          });\n          file ? this.updatePathAndDir(file) : this.handleError(\"cd \".concat(dir, \": No such file or directory\"));\n        }\n      } else {\n        debugger;\n      }\n    }\n  }]);\n\n  return FileSystem;\n}();\n\n\n\n//# sourceURL=webpack://terminal/./src/FileSystem.js?");
